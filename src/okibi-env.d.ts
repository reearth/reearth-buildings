...
declare namespace Cloudflare {
  interface Env {
    ...
    /**
     * Reads the Analytics Engine SQL API, for the daily digest the cron
     * takes. Absent means no digest is taken and tiles are served exactly as
     * before — the events are still written either way.
     *
